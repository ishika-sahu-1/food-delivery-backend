...
const delivery_partner_entity_1 = require("./entities/delivery_partner.entity");
const delivery_partner_device_entity_1 = require("./entities/delivery_partner_device.entity");
...
exports.DeliveryModule = DeliveryModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([delivery_partner_entity_1.DeliveryPartner, delivery_partner_device_entity_1.DeliveryPartnerDevices])],
