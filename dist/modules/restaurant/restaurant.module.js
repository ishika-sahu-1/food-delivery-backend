...
const restaurant_hours_entity_1 = require("./entities/restaurant_hours.entity");
const restaurant_images_entity_1 = require("./entities/restaurant_images.entity");
...
exports.RestaurantModule = RestaurantModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([restaurant_entity_1.Restaurant, restaurant_hours_entity_1.RestaurantHours, restaurant_images_entity_1.RestaurantImages])],
